        ...
        <el-dialog v-model="dialogVisible" title="请选择时间" width="30%">
            <el-form :model="form" label-width="120px">
                ...
                <el-form-item label="开始时间">
                    <el-input style="width: 80%" type="number" v-model="startime" @change="validateStartTime"></el-input>
                </el-form-item>
                <el-form-item label="结束时间">
                    <el-input style="width: 80%" type="number" v-model="endtime" @change="validateEndTime"></el-input>
                </el-form-item>
            </el-form>
    ...
    methods: {
        ...
        validateEndTime() {
            if (this.endtime < 8 || this.endtime > 22) {
                ...
                this.endtime = ''; // 清空结束时间
            }else if(parseInt(this.endtime) <= parseInt(this.startime)){
        ...
        load() {
            ...
            request.get("/seats", {
                ...
                for (let j = 0; j < this.tableData.length; j++) {
                    ...
                    console.log(this.tableData[j].close)
                    if(this.tableData[j].close == "1"){
                        this.tableData[j].time = ["维修中"]
                    }
                }
