      ...
      <el-dialog v-model="dialogVisible" title="上架书籍" width="30%">
        <el-form :model="form" label-width="120px">
          ...
          <el-form-item label="图书封面">
            <el-upload class="upload-demo" :file-list="form.coverImageUrl"
              :on-success="handleUploadSuccess" :on-remove="handleUploadRemove" :before-upload="beforeUpload"
  ...
  methods: {
    ...
    save() {
      ...
      if (this.form.id) {
        ...
        formData.append('file', this.form.coverImageUrl);
